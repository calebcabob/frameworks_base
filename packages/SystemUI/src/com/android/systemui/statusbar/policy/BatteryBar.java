...
public class BatteryBar extends RelativeLayout implements Animatable {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observer() {
            ...
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.BATTERY_BAR), false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.BATTERY_BAR_COLOR), false,
                    this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.BATTERY_BAR_CHARGING_COLOR),
                    false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(
                            Settings.System.BATTERY_BAR_BATTERY_LOW_COLOR), false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.BATTERY_BAR_ANIMATE),
                    false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(
                            Settings.System.BATTERY_BAR_ENABLE_CHARGING_COLOR), false,
                    this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.BATTERY_BAR_BLEND_COLORS),
                    false, this);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(
                            Settings.System.BATTERY_BAR_BLEND_COLORS_REVERSE), false,
                    this);
        }
    ...
    private void updateSettings() {
        ...
        mChargingColor = Settings.System.getInt(resolver,
                Settings.System.BATTERY_BAR_CHARGING_COLOR, 0xFFFFFFFF);
        mBatteryLowColor = Settings.System.getInt(resolver,
                Settings.System.BATTERY_BAR_BATTERY_LOW_COLOR, 0xFFFFFFFF);
        ...
        mUseChargingColor = Settings.System.getInt(resolver,
                Settings.System.BATTERY_BAR_ENABLE_CHARGING_COLOR, 1) == 1;
        mBlendColors = Settings.System.getInt(resolver,
                Settings.System.BATTERY_BAR_BLEND_COLORS, 0) == 1;
        mBlendColorsReversed = Settings.System.getInt(resolver,
                Settings.System.BATTERY_BAR_BLEND_COLORS_REVERSE, 0) == 1;
